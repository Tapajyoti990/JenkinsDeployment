...
//    @Test
//    public void update_UserStatus_Valid_Details(){
//        List<Document>docs =  governmentAuthorityController.getAllPendingApprovals();
//        System.out.println("Doc size is"+ docs.size());
//        if(docs.size()!=0){
//            Document docFirst = docs.get(0);
//            User user = docFirst.getUser();
//            assertThat(user.getStatus(),equalTo(AccountStatus.INITIATED));
//            Long id = user.getId();
//            UpdateApprovalRequest updateApprovalRequest = new UpdateApprovalRequest();
//            updateApprovalRequest.setUserId(id);
//            updateApprovalRequest.setStatus(AccountStatus.APPROVED);
//            governmentAuthorityController.updateUserStatus(updateApprovalRequest);
//           User user1 =  userService.findById(id).get();
//           assertThat(user1.getStatus(),equalTo(AccountStatus.APPROVED));
//        }
//    }
